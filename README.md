...
Ill add GHL support later on :)

- [Introduction](#introduction)
- [Class Reference](#class-reference)
    - [LuaChart.Chart](#luachartchart)
    - [LuaChart.SyncTrackEvent](#luachartsynctrackevent)
        - [LuaChart.SyncTrackEventType.TimeSignature](#luachartsynctrackeventtypetimesignature)
        - [LuaChart.SyncTrackEventType.BPM](#luachartsynctrackeventtypebpm)
        - [LuaChart.SyncTrackEventType.Anchor](#luachartsynctrackeventtypeanchor)
    - [LuaChart.GlobalEvent](#luachartglobalevent)
        - [LuaChart.GlobalEventType.Section](#luachartglobaleventtypesection)
        - [LuaChart.GlobalEventType.Other](#luachartglobaleventtypeother)
    - [LuaChart.InstrumentTrack](#luachartinstrumenttrack)
    - [LuaChart.Note](#luachartnote)
        - [5 Fret](#5-fret)
        - [Drums](#drums)
    - [LuaChart.LocalEvent](#luachartlocalevent)
        - [LuaChart.LocalEventType.StarPowerPhrase](#luachartlocaleventtypestarpowerphrase)
        - [LuaChart.LocalEventType.Other](#luachartlocaleventtypeother)
- [Enumerators](#enumerators)
    - [LuaChart.LocalEventType](#luachartlocaleventtype)
    - [LuaChart.GHLInstrumentType](#luachartghlinstrumenttype)
    - [LuaChart.InstrumentType](#luachartinstrumenttype)
    - [LuaChart.DifficultyType](#luachartdifficultytype)
    - [LuaChart.GlobalEventType](#luachartglobaleventtype)
    - [LuaChart.SyncTrackEventType](#luachartsynctrackeventtype)
